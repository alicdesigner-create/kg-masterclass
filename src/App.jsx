...
export default function KGMasterClass() {
      ...
      <div className="py-2.5 px-3 flex items-center relative">
        ...
        <div className="absolute left-0 right-0 flex justify-center pointer-events-none">
          <button onClick={goHome} className="pointer-events-auto">
            <img src="/kg-university-logo.png" alt="KG University" className="h-12 object-contain" />
          </button>
        </div>
  ...
  const searchIndex = [
    ...
    { id: 'dawn',       type: 'chemical', screen: 'chemicals', image: '/quimicos/dawn.jpg',       icon: '🧴', nameEn: 'Dawn Ultra Dish Soap',        nameEs: 'Dawn Ultra Dish Soap',           descEn: 'Surfactant concentrate for degreasing',   descEs: 'Concentrado surfactante para desengrase', keywords: ['dawn','dish','soap','degreaser','chrome','metal','glass','surfactant','grease','oil','oxidation'] },
  ];
  ...
  const renderHome = () => (
    <div className="min-h-screen bg-slate-50 pb-52">
      ...
      <div className="relative pt-14 pb-20 text-center overflow-hidden">
        ...
        >
          <img src="/kg-university-logo.png" alt="KG University" className="h-24 mx-auto object-contain drop-shadow-lg" />
  ...
  const chemicalProductBase = [
    ...
    { id: 'dawn',       name: 'Dawn Ultra Dish Soap',        image: '/quimicos/dawn.jpg'       },
  ];
